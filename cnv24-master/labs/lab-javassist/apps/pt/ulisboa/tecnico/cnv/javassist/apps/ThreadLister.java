...
public class ThreadLister {
  ...
  private static void printThreadInfo(PrintWriter out, Thread t, 
                                        String indent) {
    if (t == null) return;
    String isDaemon = t.isDaemon() ? " Daemon":"";
    String isAlive = t.isAlive()   ? ""       :" Not Alive";
    out.println(indent + "Thread: " + t.getName() + "  Priority: " + t.getPriority() + isDaemon + isAlive);
  }
  ...
  private static void printGroupInfo(PrintWriter out, ThreadGroup g, 
    ...
    String isDaemon = g.isDaemon() ? " Daemon" : "";
    out.println(indent + "Thread Group: " + g.getName() + "  Max Priority: " + g.getMaxPriority() + isDaemon);
